...
enum UserSelectablePins
{
    ...
    GPIO_TX,     // Serial interface
    GPIO_RX,     // Serial interface
};
...
const mytmplt Modules[] PROGMEM = {
...
#elif defined USE_COVER
    {
        "Huex Cover",   // Huex Cover (ESP8266)
        GPIO_KEY2,      // GPIO00 Button
        GPIO_NONE,      // GPIO01
        GPIO_NONE,      // GPIO02
        GPIO_NONE,      // GPIO03
        GPIO_LED_POWER, // GPIO04 Led (1 = On, 0 = Off) - Link and Power status
        0,              // GPIO05
        // GPIO06 (SD_CLK   Flash)
        // GPIO07 (SD_DATA0 Flash QIO/DIO/DOUT)
        // GPIO08 (SD_DATA1 Flash QIO/DIO/DOUT)
...
#elif defined USE_ZINGUO
    {
        ...
        GPIO_NONE, // GPIO02
        GPIO_NONE, // GPIO03
        GPIO_NONE, // GPIO04 Led (1 = On, 0 = Off) - Link and Power status
        GPIO_NONE, // GPIO05
        // GPIO06 (SD_CLK   Flash)
        // GPIO07 (SD_DATA0 Flash QIO/DIO/DOUT)
        // GPIO08 (SD_DATA1 Flash QIO/DIO/DOUT)
