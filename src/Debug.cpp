...
void DebugClass::GetLog(uint8_t idx, char **entry_pp, uint16_t *len_p)
{
	char *entry_p = NULL;
	size_t len = 0;
...
void DebugClass::AddLog(uint8_t loglevel)
{
...
void DebugClass::AddLog(uint8_t loglevel, PGM_P formatP, ...)
{
	va_list arg;
