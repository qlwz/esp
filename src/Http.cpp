...
void Http::handleRoot()
{
    ...
    page += F("</div><div style='text-align:center;margin-top:20px;'>作者：<a href='https://github.com/qlwz' target='_blank'>情留メ蚊子</a>&nbsp;&nbsp;&nbsp;<a href='https://bbs.iobroker.cn' target='_blank'>来和大神一起玩智能家居</a></div>");
    radioJs += F("</script>");
